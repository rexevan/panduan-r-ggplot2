...
\begin{center}\includegraphics[width=0.9\linewidth]{Panduan_files/figure-latex/gg-diamonds-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{Panduan_files/figure-latex/scatter-plot-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{Panduan_files/figure-latex/file-aktualisasi-1} \end{center}
